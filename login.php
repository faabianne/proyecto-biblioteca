<?php
session_start();
// Si la cookie existe, entra directo según la lógica de la imagen[cite: 2, 4]
    ...
    <div class="card biblioteca-card" style="width: 100%; max-width: 400px;">
        ...
        <div class="card-body p-4">
            <form action="validar_login.php" method="POST">
                ...
                <button type="submit" class="btn btn-biblioteca w-100 py-2 mb-3">Entrar</button>
            </form>
            <div class="text-center small">
                <a href="registro.php" class="text-decoration-none" style="color: #8d6e63;">Crear una cuenta</a>
            </div>
        </div>
    </div>
</div>
